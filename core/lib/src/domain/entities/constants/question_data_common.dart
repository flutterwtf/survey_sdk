abstract class QuestionDataCommon {
  static const String choiceQuestionContent = 'You may simply need a single, '
      ...
      'the type of answer you receive.';
  static const choiceQuestionOptions = [
    'First option',
    'Second option',
    'Third option'
  ];
  static const choiceQuestionTitle = 'Title';
  static const choiceQuestionSubtitle = '';

  static const inputQuestionTitle =
      'Why is asking the right type of questions important?';
  static const inputQuestionSubtitle = '';
  static const inputQuestionContent =
      'Doing so can help you gather the information most '

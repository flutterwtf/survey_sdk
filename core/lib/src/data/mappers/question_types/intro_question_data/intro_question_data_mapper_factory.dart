import 'package:survey_sdk/src/data/mappers/question_types/intro_question_data/intro_question_data_mapper_ver1.dart';
...
abstract class IntroQuestionDataMapperFactory {
  static final List<QuestionDataMapper> _implementations = [
    /// _implementations contains all versions IntroQuestionDataMapper
    IntroQuestionDataMapperVer1(),
  ];
